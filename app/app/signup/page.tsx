      ...
      <div className="relative w-full max-w-md">
        <div className="rounded-2xl border border-slate-800 bg-slate-900/90 backdrop-blur-xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">Join the VYNS community today</p>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div className="flex items-start gap-3">
              <button
                ...
                className={`mt-0.5 h-5 w-5 rounded border flex items-center justify-center transition-all cursor-pointer ${
                  agreedToTerms
